...
(function () {
    ...
    ui.Pages.define(searchPageURI, {
        ready: function (element, options) {
            var firstLetter = options.queryText[0].toUpperCase();
            WinJS.Binding.processAll(element, search(firstLetter))
        },
    ...
    var search = function (firstLetter) {
        ViewModels.getCategories(firstLetter);
    }
